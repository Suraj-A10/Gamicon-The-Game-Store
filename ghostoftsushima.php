...
<head>
  ...
  <title>Ghost of Tsushima - PC</title>
...
<div class="container py-4">
  <div class="row">
    <!-- Left Section -->
    <div class="col-md-7">
      <div class="game-title">Ghost of Tsushima (PC)</div>
      ...
      <p class="mt-3">
        In this open-world action adventure, you'll roam vast countryside and expansive terrain to encounter rich characters, discover ancient landmarks, and uncover the hidden beauty of Tsushima. Challenge opponents with your katana, master the bow to eliminate distant threats, develop stealth tactics to ambush enemies, and explore a new story on Tsushima Island.
      </p>

      <p><strong>Included with:</strong> <span class="text-success">Game Pass</span> | <a href="#">1 of 2 editions</a></p>

      <div class="d-flex gap-3 mt-3">
        <a href="payment_purchase.php?game=Ghost of Tsushima&price=3999"><button class="btn install-btn px-4 py-2">₹ 3999</button></a>
        <a href="payment_rent.php?game=Ghost of Tsushima&price=799"><button class="btn rent-btn px-4 py-2">Rent 7 Days ₹ 799</button></a>
    ...
    <div class="col-md-5">
      <!-- Main Image -->
      <img id="mainImage" src="./IMG/gameimg/ghost.webp" class="game-img mb-3" alt="Main Game Image">

      <!-- Thumbnails + Next Button -->
      <div class="d-flex align-items-center">
        <img src="./IMG/gameimg/ghost.webp" class="thumb-img active" onclick="changeImage(this)">
    ...
    <div class="col-md-8">
      <div class="bg-dark rounded p-4">
        ...
        <div class="row mb-3" style="color: aliceblue;">
          <div class="col-md-3"><small class="text-muted">Developed by</small><br><strong>Sucker Punch</strong></div>
          <div class="col-md-3"><small class="text-muted">Published by</small><br><strong>Sony Interactive</strong></div>
          <div class="col-md-3"><small class="text-muted">Release date</small><br><strong>05-16-2025</strong></div>
          <div class="col-md-3"><small class="text-muted">Install size</small><br><strong>75.32 GB</strong></div>
        </div>
