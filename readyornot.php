...
<div class="container py-4">
  <div class="row">
    <!-- Left Section -->
    <div class="col-md-7">
      <div class="game-title">Ready or Not (PC)</div>
      ...
      <p class="mt-3">
        Ready or Not is an intense, tactical, first-person shooter that depicts a modern-day world in which SWAT police units are called to defuse hostile and confronting situations. Experience a high-stakes game of tactical combat where split-second decisions can mean the difference between life and death.
      </p>

      <p><strong>Included with:</strong> <span class="text-success">Game Pass</span> | <a href="#">Standard Edition</a></p>

      <div class="d-flex gap-3 mt-3">
        <a href="payment_purchase.php?game=Ready or Not&price=3999"><button class="btn install-btn px-4 py-2">₹ 3999</button></a>
        <a href="payment_rent.php?game=Ready or Not&price=799"><button class="btn rent-btn px-4 py-2">Rent 7 Days ₹ 799</button></a>
    ...
    <div class="col-md-5">
      ...
      <div class="d-flex align-items-center">
        <img src="./IMG/gameimg/ready.jpg" class="thumb-img active" onclick="changeImage(this)">
    ...
    <div class="col-md-8">
      <div class="bg-dark rounded p-4">
        ...
        <div class="row mb-3" style="color: aliceblue;">
          <div class="col-md-3"><small class="text-muted">Developed by</small><br><strong>VOID Interactive</strong></div>
          <div class="col-md-3"><small class="text-muted">Published by</small><br><strong>VOID Interactive</strong></div>
          <div class="col-md-3"><small class="text-muted">Release date</small><br><strong>03-22-2025</strong></div>
          <div class="col-md-3"><small class="text-muted">Install size</small><br><strong>45.67 GB</strong></div>
        </div>
        <p class="text-secondary mb-2" style="font-size: 0.95rem;">
          VOID Interactive's Ready or Not is a realistic tactical first-person shooter that places you in the boots of an elite SWAT team, tasked with defusing hostile situations in intense, claustrophobic environments.
        </p>
        <p class="text-secondary mb-0" style="font-size: 0.95rem;">
          Players will need to strategize, execute, and adapt their tactics as they command a squad of operatives through a variety of high-stakes scenarios. Every decision matters, and split-second choices can mean the difference between saving lives or tragedy...
        </p>
        <p class="mt-2 mb-0">
    ...
    <div class="col-md-4">
      ...
      <div class="bg-dark rounded p-4">
        ...
        <div class="d-flex flex-wrap gap-2">
          <span class="badge bg-secondary">Online multiplayer (2-8)</span>
