...
if(isset($_POST['proceed_payment'])) {
    ...
    if(isset($_SESSION['user_id'])) {
        ...
        echo "<script>alert('Please login to rent a game.'); window.location.href='login.php';</script>";
        exit();
    }
    
    // Insert into rented table
    $sql = "INSERT INTO rented (useremail, gamename, price) VALUES (?, ?, ?)";
...
<head>
  <meta charset="UTF-8">
  <title>Payment Gateway - 7-Day Rental</title>
...
<div class="container payment-container">
  <div class="game-details">
    <h4>Rental Details <span class="rental-badge">7-DAY TRIAL</span></h4>
    <div class="row">
      <div class="col-md-8">
        <p><strong>Game:</strong> <?php echo htmlspecialchars($game); ?></p>
        <p><strong>Type:</strong> 7-Day Rental (Access expires after 7 days)</p>
        <p><small>* You can upgrade to a full purchase anytime during the rental period</small></p>
      </div>
